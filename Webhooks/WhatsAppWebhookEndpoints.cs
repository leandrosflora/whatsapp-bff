...
namespace whatsapp_bff.Webhooks;
...
public static class WhatsAppWebhookEndpoints
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        Models.WhatsApp.WhatsAppWebhookPayload? payload;
        try
        {
            payload = JsonSerializer.Deserialize<Models.WhatsApp.WhatsAppWebhookPayload>(rawBytes);
        }
    ...
    private static bool IsDuplicateDelivery(Models.WhatsApp.WhatsAppWebhookPayload payload, IMessageDedupeStore dedupeStore)
    {
